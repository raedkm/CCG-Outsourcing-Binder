...
"rgdal", "rgeos", "tmap", "tmaptools",  "spgwr", "grid", "gridExtra","curl", "kableExtra",  "MuMIn", "parallel",
"tinytex", "zen4R", "cowplot", "ggforce", "ggthemes", "inborutils"))

library(devtools)

install_github("inbo/inborutils")
install_github("BenGoodair/CCG-Outsourcing", ref = "master")
